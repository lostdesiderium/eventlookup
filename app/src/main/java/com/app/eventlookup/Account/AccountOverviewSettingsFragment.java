...
public class AccountOverviewSettingsFragment extends Fragment {
    ...
    private void prepareLayoutComponents(View view){
        ...
        mBtnChangePassword = view.findViewById( R.id.BTN_account_overview_change_password );
        mUtils = new Utils();
        mContext = getContext();
    }
    ...
    private void prepareListeners(View view) {
        ...
        mBtnChangePassword.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mNavController.navigate( R.id.action_accountOverviewFragment_to_accountOverviewChangePassword );
            }
        } );
    }
}
